...
class ReadSerialCom : public IMU_maths
{
    public:
        ReadSerialCom(){}
        ReadSerialCom(FILE* _file, DATA_FORMAT data_format, unsigned char _data_to_display);
        ~ReadSerialCom();

        void initSerialCommunication(FILE* _file, DATA_FORMAT data_format, unsigned char _data_to_display);
