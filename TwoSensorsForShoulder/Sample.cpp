...
Sample::Sample(int _num_frame, DATA_TYPE _timestamp, Vec3 _acceleration, Vec3 _angularRate, Vec3 _magneticField, Vec3 _velocity, Vec3 _position, Vec4 _quaternion)
{
